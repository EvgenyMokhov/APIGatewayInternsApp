...
builder.Services.AddMassTransit(x => 
{
    ...
    x.AddRequestClient<GetProjectRequest>(new Uri("exchange:get-intern-requests"));
    x.AddRequestClient<GetAllProjectsRequest>(new Uri("exchange:get-all-interns-requests"));
